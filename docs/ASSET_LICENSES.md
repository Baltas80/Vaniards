...
- Sanguis font: Jupiter Hadley
- Dogica Pixel font: rmocci
- Sword sound effect: Iwan Gabovich
- JFXR-generated sounds

Those additional items are not assumed to be MIT or CC0 solely because the codebase is MIT licensed. Their original license and attribution should be retained and verified before the first public Google Play release.

The project also includes assets marked as user-added in the source. Keep a record of which resources are original to Vaniards and which are third-party.
